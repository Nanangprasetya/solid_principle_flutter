...
// API String
const String ARTICLE = 'posts/';
const String PHOTOS = 'photos/';
const String USERS = 'users/';

// Page Storage 
const String KEY_ARTICLE = 'key_article';
const String KEY_PHOTOS = 'key_photos';
const String KEY_USERS = 'key_users';

// Hive Box
const String BOX_ARTICLE = 'box_article';
const String BOX_PHOTOS = 'box_photos';
const String BOX_USERS = 'box_users';

// Hive KEY
const String BOX_KEY_ARTICLE = 'box_key_article';
const String BOX_KEY_PHOTOS = 'box_key_photos';
const String BOX_KEY_USERS = 'box_key_users';
